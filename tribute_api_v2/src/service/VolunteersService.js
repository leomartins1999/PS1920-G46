 ...
 */
var VolunteersService = /** @class */ (function (_super) {
    __extends(VolunteersService, _super);
    function VolunteersService() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    /**
     * retrieves volunteers
     */
    VolunteersService.prototype.getVolunteers = function (limit, skip, name) {
     ...
     */
    VolunteersService.prototype.getVolunteerMail = function (volunteer_id) {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (user.user_type != Structures_1.UserType.Volunteer)
                            return [2 /*return*/, Promise.reject(new Structures_1.Error('Invalid user type.'))];
                        return [2 /*return*/, { mail: user.mail }];
                }
            });
        });
    };
     ...
     * updates a volunteer
     */
    VolunteersService.prototype.updateVolunteer = function (user_id, volunteer_id, updates) {
        return __awaiter(this, void 0, void 0, function () {
            var updateResult;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, updateResult.success ?
                                new Structures_1.Status('Profile updated', true) :
                                Promise.reject(new Structures_1.Error("Update operation failed."))];
                }
            });
        });
    };
