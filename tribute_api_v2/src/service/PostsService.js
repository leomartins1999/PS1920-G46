...
var PostsService = /** @class */ (function (_super) {
     ...
     * likes post
     */
    PostsService.prototype.likePost = function (user_id, user_type, post_id) {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, updateResult.success ?
                                new Structures_1.Status('Like was changed.', true) :
                                Promise.reject(new Structures_1.Error('Like operation has failed.'))];
                }
            });
        });
    };
