...
var ImageRepository = /** @class */ (function () {
     ...
     */
    ImageRepository.generateImageId = function (type, id) {
        return type + "-" + id;
    };
    /**
     ...
     */
    ImageRepository.prototype.getImageById = function (type, id) {
        return __awaiter(this, void 0, void 0, function () {
            var image_id, query, results;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        results = _a.sent();
                        if (results.length <= 0)
                            return [2 /*return*/, Promise.reject(new Structures_1.Error("Image not found - " + image_id + "."))];
                        return [2 /*return*/, results[0].body.buffer];
                }
            });
        });
    };
