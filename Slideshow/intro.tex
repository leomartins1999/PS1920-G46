...
\scalebox{0.5}{\includegraphics{Figures/volunteering_example}}\\
...
\vspace*{-2em}
\scalebox{0.2}{\includegraphics{Figures/services-decentralized}}\\
...
\vspace*{1em}
\scalebox{0.2}{\includegraphics{Figures/services-centralized}}\\
