...
var EventsService = /** @class */ (function (_super) {
     ...
     * updates an event
     */
    EventsService.prototype.updateEvent = function (user_id, event_id, updates) {
     ...
     */
    EventsService.prototype.interestedInEvent = function (user_id, event_id) {
        return __awaiter(this, void 0, void 0, function () {
            var event, updateResult;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (event.interested[user_id])
                            delete event.interested[user_id];
                        else
